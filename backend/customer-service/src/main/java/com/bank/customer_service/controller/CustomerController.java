...
public class CustomerController {
    ...
    public ResponseEntity<CustomerResponse> updateCustomer(@PathVariable long id, @Valid @RequestBody CustomerRequest request) {
        CustomerResponse customerResponse = customerService.updateCustomer(request, id);
        return ResponseEntity.status(HttpStatus.ACCEPTED).body(customerResponse);
    }

    @Operation(summary = "Récupérer tous les clients", description = "Récupère tous les clients")
