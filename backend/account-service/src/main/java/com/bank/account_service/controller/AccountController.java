...
public class AccountController {
    ...
    @Operation(summary = "Mettre à jour un compte", description = "Met à jour les informations d'un compte existant en utilisant son ID")
    @Schema(implementation = AccountRequest.class)
    ...
    @ApiResponse(responseCode = "400", description = "Données de requête non valides")
    @PutMapping("/{id}")
